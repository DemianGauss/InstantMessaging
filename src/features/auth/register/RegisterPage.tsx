...
export function RegisterPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      const msg = apiError.response?.data?.message || "注册失败，请稍后再试";
          ...
          {success ? (
            ...
            <>
              <form onSubmit={onSubmit} noValidate>
                ...
                {/* Confirm Password */}
                <div
                  className={`${styles["retro-field"]} ${confirmError ? styles.error : ""}`}
                >
                  <div className={styles["field-chrome"]}>
                    <div className={styles["chrome-border"]} />
                    <input
                  ...
                  <span
                    className={`${styles["retro-error"]} ${confirmError ? styles.show : ""}`}
                  >
                    {confirmError}
                  </span>
                </div>
